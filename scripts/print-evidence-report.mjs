...
const zipPath = path.resolve('interaction-evidence-v11.zip');
const extractDir = path.resolve('interaction_evidence_v11_extracted');
...
console.log('=== EXTRACTING AND VERIFYING EVIDENCE V11 ARCHIVE ===');
...
console.log('\n✅ EVIDENCE V11 VERIFICATION COMPLETE!');
